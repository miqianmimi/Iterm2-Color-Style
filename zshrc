...
export ZSH=/Users/miqian/.oh-my-zsh
...
#POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(background_jobs ram load time battery)
DEFAULT_USER="miqian"
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time history ram load ip time)
...
plugins=(zsh-autosuggestions zsh-syntax-highlighting git web-search sublime colorize)
